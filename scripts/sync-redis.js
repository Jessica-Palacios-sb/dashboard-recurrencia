...
const ENDPOINTS = [
  ...
  SELECT
    ...
    f.due_date, f.fecha_pago, f.total_amount_usd, f.payment_amount_usd, f.open_balance,
    f.estado, f.metodo_pago, o.tipo_pago, o.tipo_venta, o.sub_tipo_venta,
    o.tiempo_meses_estudio, o.pais_lead, o.num_cuotas, o.fecha_cierre AS fecha_cierre,
    CASE
    ...
    e.tipo_suscripcion, o.tiempo_recurrencia AS frecuencia_suscripcion, e.converted_date,
    CASE
    ...
    CASE WHEN o.tipo_venta IN ('Up-Selling','Cross-Selling','Upgrade OPS','Freemium Cross-Selling') THEN 1 ELSE 0 END AS es_upgrade,
